...
class AddHospitalsCommand extends Command
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addArgument('file', InputArgument::OPTIONAL, 'Путь к НСИ справочнику медицинских организаций в формате csv в папке data')
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        if (null !== $file) {
            ...
            $file = $this->io->ask('Файл', null, [$this->validator, 'validateCsvFile']);
